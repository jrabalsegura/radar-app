...
from aemet_radar.hybrid_service import HybridIngestionService, IngestionOutcome
...
class NationalIngestionService:
    ...
    def __init__(
        ...
        self._store = store
        self._timeline: NationalTimeline | None = None
    ...
    def fetch_once(self, product: RadarProduct) -> IngestionOutcome:
        try:
            frames = self._current_timeline().visible_frames()
        ...
        latest_image: NationalImage | None = None
        latest_inspection: NationalInspection | None = None
        ...
        if latest_is_archived:
            ...
            try:
                ...
                latest_inspection = inspect_national_png(
    ...
    def _current_timeline(self) -> NationalTimeline:
    ...
    def _archive_frame(
        ...
        image: NationalImage,
        inspection: NationalInspection,
        coordinates: MapCoordinates,
    ) -> str:
        report = _build_national_report(
            product,
            image,
            inspection,
            coordinates,
...
def _build_national_report(
    ...
    return {
        ...
        "source": {
            "provider": "aemet-viewer-national",
        ...
        "productTime": {
            ...
            "source": "aemet-viewer-national-filename",
            "confidence": "high",
